...
def angular_dist_score(
    ...
    This is the official Kaggle IceCube metric. It computes the 3D angular
    separation between direction unit vectors in radians.
...
class AngularDistanceLoss(nn.Module):
    ...
    Uses the official Kaggle IceCube metric: mean angular distance
    between predicted and true neutrino directions.
